...
public class CodingFrequencies implements Iterable<Integer> {
	...
	private CodingFrequencies(final int[] frequencies, final HashMap<Number, Integer> overflow, 
			final int frequencyTotal, final int minimumValue, final int maximumValue, final Indexing indexing) {
